...
describe("Traversing DOM elements in Cypress", () => {
  beforeEach(() => {
    ...
    it("children() to get the children of DOM elements to verify contact us has active class", () => {
      cy.get(".traversal-breadcrumb").children(".active").should("contain", "Contact Us")
    });
  
    it("closest() to validate the closest ancestor DOM element ul to have specific class", () => {
    ...
    it("filter() to retrieve DOM elements that match a specific selector class active", () => {
